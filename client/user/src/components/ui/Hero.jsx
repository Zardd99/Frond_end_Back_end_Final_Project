        ...
        <>
          <div key={content.title}>
            ...
            <div className="flex cal-sans-regular gap-4 text-2xl">
              <Link
                className="group flex items-center gap-2 mr-6 p-2 pr-4 text-light bg-bold-red hover:bg-bold-red-hover rounded-[50px] "
                to="/allmenu"
              >
              ...
              <button className="group text-dark flex items-center gap-2 mr-6 p-2 pr-4">
